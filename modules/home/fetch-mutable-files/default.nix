...
let
  cfg = config.arclight.home.mutableFile;
...
in
{
  options.arclight.home.mutableFile = lib.mkOption {
    type = with lib.types; attrsOf (submodule (fileType "/home/${config.arclight.user.name}"));
    description = ''
